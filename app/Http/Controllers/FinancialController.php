...
class FinancialController extends Controller
{
    ...
    public function __construct(Financial $financial, User $user, Lead $lead, Action $action)
    {
    ...
    public function edit($id)
    {
        ...
        if($financial)
        {
            return view('admin.financials.edit',['financial' => $financial]);
        } else {
    ...
    public function confirm($id) 
    {
        ...
        return redirect('admin/financial/edit/'.$installment->financial_id)->with('alert', 'Desculpe! Não encontramos o registro!');
    }
