        ...
        <div>
            <form method="GET" action="{{route('admin.users.index')}}">
                <div class="input-group input-group-md">
                    <input type="text" name="search" class="form-control" placeholder="Nome" required>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Lista de usuários administradores do sistema</h3>
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-hover table-striped">
                <thead>
                    <tr>
                        <th class="py-2" style="width: 60px;">Foto</th>
                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td class="py-2 px-2">
                                <a href="{{route('admin.users.edit',['id' => $user->id])}}" class="btn btn-block btn-info btn-xs" title="Alterar registro">
