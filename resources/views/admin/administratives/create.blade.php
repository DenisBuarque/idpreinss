                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                <small>CPF: *</small>
                                <input type="text" name="cpf" value="{{ old('cpf') }}" onkeypress="mascara(this, '###.###.###-##')"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" onkeypress="mascara(this, '## #####-####')"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="inss" id="inss" value="{{ old('inss') }}" class="form-control @error('inss') is-invalid @enderror"
                                    maxlength="30" />
                                    @error('inss')
                                        <div class="text-red">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="col-sm-9">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="situation" id="situation" value="{{ old('situation') }}" class="form-control @error('situation') is-invalid @enderror"/>
                                    @error('situation')
                                        <div class="text-red">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                ...
                                <input type="date" name="initial_date" id="initial_date" value="{{ old('initial_date') }}" class="form-control @error('initial_date') is-invalid @enderror"
                                    maxlength="2" />
                                    @error('initial_date')
                                        <div class="text-red">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                <small>Sessaçãossão do beneficio: *</small>
                                <input type="date" name="concessao_date" id="concessao_date" value="{{ old('concessao_date') }}" class="form-control @error('concessao_date') is-invalid @enderror"
                                    maxlength="2" />
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="fees" id="fees" value="{{ old('fees') }}" onkeyup="moeda(this);" class="form-control @error('fees') is-invalid @enderror"
