                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <p class="m-0" style="line-height: 1">
                                    ...
                                    <small>{{ $administrative->user->address }}, {{ $administrative->user->number }}, {{ $administrative->user->district }},
                            ...
                            <td class="py-2">
                                <p class="m-0" style="line-height: 1">
                                    {{ $administrative->name }}
                                    <br /><small>{{ $administrative->address }}, {{ $administrative->number }},
