...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.administratives.update', ['id' => $administrative->id]) }}"
            enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            @method('PUT')
            <div class="card card-info" style="max-width: 900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário edição do administrativo:</h3>
                </div>
                <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                            ...
                            <input type="date" name="initial_date" id="initial_date" value="{{ $administrative->initial_date ?? old('initial_date') }}" class="form-control @error('initial_date') is-invalid @enderror"
                                maxlength="2" />
                                @error('initial_date')
                                    <div class="text-red">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                            ...
                            <input type="date" name="concessao_date" id="concessao_date" value="{{ $administrative->concessao_date ?? old('concessao_date') }}" class="form-control @error('concessao_date') is-invalid @enderror"
                                maxlength="2" />
